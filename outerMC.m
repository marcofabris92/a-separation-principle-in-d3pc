...
% - reg_weight.m, to compute the regularization weights used in ol_thm4.m
...
function [clx,sys,dpc,exe_time,...
    ...
    y_thm4_tuned_KF,n2_gamma12_thm4_tuned,beta_thm4_tuned,...
...
Jthm4_tuned(j) = sol.J;
Ju_thm4_tuned(j) = sol.Ju;
Jy_thm4_tuned(j) = sol.Jy;
u_thm4_tuned(:,:,j) = sol.uf;
y_thm4_tuned(:,:,j) = sol.yf_hat;
y_thm4_tuned_TR(:,:,j) = sol.yf;
